...
<el-dropdown class="inline-block">
  <button class="inline-flex items-center min-w-[255px] h-[58px] justify-center gap-x-1.5 rounded-full bg-black px-3 py-2 text-sm-3 font-bold text-white uppercase cursor-pointer">
    <?php echo esc_html($dropdown['title']); ?>
    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/icons/chevron-down-white.svg" alt="">
  </button>
