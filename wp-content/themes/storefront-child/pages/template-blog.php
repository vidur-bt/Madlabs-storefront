    ...
    <div class="w-[358px] sm:w-[571px] max-w-[571px] mb-[30.76px] sm:mb-[49px]">
      <div class="relative">
        <input
          ...
          class="w-full rounded-[10px] text-[13px] sm:text-[16px] placeholder:text-black bg-gray-2 border-black py-[4.75px] sm:py-[11px] px-4 pr-10 focus:outline-none focus:ring-1 focus:ring-black tracking-[-1.08px]"
        />
    ...
    <div class="w-full flex flex-col items-center">
      ...
      <div class="bg-gray-2 mb-[37.2px] sm:mb-[62px] rounded-[26px] overflow-hidden 
        ...
        <div class="pt-[17px] sm:pt-4 pb-[14px] sm:pb-6 px-8">
          <h2 class="text-base sm:text-lg text-[15px] sm:text-[20px] font-semibold font-sans tracking-[-1.08px]">6 Best THC Edibles Reviewed for 2025</h2>
          <p class="text-xs sm:text-[15px] mt-3 line-clamp-2 sm:line-clamp-none tracking-[-1.08px]">
          ...
          <div class="flex justify-between items-center mt-3 sm:mt-4 text-xs sm:text-sm ">
            <div class="flex items-center space-x-1">
              ...
              <span class="text-[9px] sm:text-[12px] tracking-[-1.08px]">Jan 2025</span>
            </div>
      ...
      <div class="bg-gray-2 mb-[37.2px] sm:mb-[62px] rounded-[26px] overflow-hidden 
        ...
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/generative.png" 
             ...
             class="w-full h-auto object-cover" />
        <div class="pt-[17px] sm:pt-4 pb-[14px] sm:pb-6 px-8">
          <h2 class="text-base sm:text-lg text-[15px] sm:text-[20px] font-semibold font-sans tracking-[-1.08px]">10 Best Cannabis-Infused Drinks for Dry</h2>
          <p class="text-xs sm:text-[15px] mt-3 line-clamp-2 sm:line-clamp-none tracking-[-1.08px] ">
           The hemp edible market has evolved dramatically over the past few years, and as we approach 2025, hemp gummies are at the forefront of cannabis innovation...
          </p>
          <div class="flex justify-between items-center mt-3 sm:mt-4 text-xs sm:text-sm ">
      ...
      <div class="bg-gray-2 mb-[37.2px] sm:mb-[62px] rounded-[26px] overflow-hidden 
        ...
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/enerative.png" 
             ...
             class="w-full h-auto object-cover" />
        <div class="pt-[17px] sm:pt-4 pb-[14px] sm:pb-6 px-8">
          <h2 class="text-base sm:text-lg text-[15px] sm:text-[20px] font-semibold font-sans tracking-[-1.08px]">Hemp Gummies for Self-Care This Valentine’s Day</h2>
          <p class="text-xs sm:text-[15px] mt-3 line-clamp-2 sm:line-clamp-none tracking-[-1.08px] ">
